...
def alpha_find_board_value(board, depth,alpha,beta,eval_fn,
    ...
    for move, new_board in get_next_moves_fn(board):
        val = -1 * alpha_find_board_value(new_board,-beta,-alpha, depth-1, eval_fn,
...
def alpha_beta_search(board, depth, eval_fn = basic_evaluate,
            get_next_moves_fn = get_all_next_moves,
            is_terminal_fn = is_terminal,
            verbose = True):
    """
    ...
    for move, new_board in get_next_moves_fn(board):
        val = -1 * alpha_find_board_value(new_board, depth-1,-beta,-alpha, eval_fn,
                                            get_next_moves_fn,
                                            is_terminal_fn)
